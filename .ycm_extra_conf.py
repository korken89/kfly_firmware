# Generated by YCM Generator at 2016-09-23 18:35:30.234524
...
flags = [
    ...
    '-DTHUMB_PRESENT',
    '-I.',
    '-I./ChibiOS/ext/fatfs/src',
    '-I./ChibiOS/os/common/ext/CMSIS/ST/STM32F7xx',
    ...
    '-I./ChibiOS/os/common/startup/ARMCMx/devices/STM32F7xx',
    '-I./ChibiOS/os/hal/include',
    '-I./ChibiOS/os/hal/lib/streams',
    '-I./ChibiOS/os/hal/osal/rt',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/ADCv2',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/CANv1',
    ...
    '-I./ChibiOS/os/hal/ports/STM32/LLD/I2Cv2',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/MACv1',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/OTGv1',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/QUADSPIv1',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/RTCv2',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/SDMMCv1',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/SPIv2',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/TIMv1',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/USARTv2',
    '-I./ChibiOS/os/hal/ports/STM32/LLD/xWDGv1',
    '-I./ChibiOS/os/hal/ports/STM32/STM32F7xx',
